export const metadata = {
  title: "นโยบายความเป็นส่วนตัว | EvelyAI",
};
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-8 text-foreground">
      ...
      <div className="flex flex-col gap-6 text-[15px] leading-relaxed text-foreground/90">
        <section>
          <p>
            นโยบายนี้อธิบายวิธีที่ EvelyAI (&ldquo;เรา&rdquo;) เก็บรวบรวม ใช้ และเปิดเผย
        ...
        <section>
          ...
          <p>
            เราไม่จำหน่ายข้อมูลส่วนบุคคลของคุณ ข้อมูลข้อความในบทสนทนาจะถูกส่งไปยังผู้ให้บริการประมวลผล LLM (เช่น OpenRouter)
