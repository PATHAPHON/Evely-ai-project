...
[![Vitest](https://img.shields.io/badge/Tests-191%20Passed-brightgreen?style=flat-square&logo=vitest)](https://vitest.dev/)
...
```bash
# รัน Unit Tests ทั้งหมด (Vitest 191+ tests)
npm test
...
|---|---|---|---|
| 🟢 **Free User** | `free-demo@evelyai.local` | `demo1234` | มี 16 คำศัพท์ในระบบ (6 คำครบกำหนดทบทวนใน `/refresh`) |
| 💎 **Premium User** | `premium-demo@evelyai.local` | `demo1234` | ปลดล็อก AI Suggestions และ Grammar Correction |
| ⚠️ **Budget Max** | `budget-max@evelyai.local` | `demo1234` | ทดสอบการแสดงผล Banner เตือนงบประมาณรายวันเต็ม (429) |
