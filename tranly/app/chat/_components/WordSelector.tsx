...
export default function WordSelector({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/40">
      <div className="w-full max-w-md rounded-t-2xl border-3 border-black bg-white shadow-[4px_4px_0_#000000] flex flex-col max-h-[80vh]">
        {/* Header */}
        <div className="flex items-center justify-between border-b-3 border-black p-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="flex h-8 w-8 items-center justify-center rounded-lg border-3 border-black bg-white shadow-[3px_3px_0_#000000] transition-all duration-100 active:translate-y-[2px] active:shadow-[1px_1px_0_#000000] cursor-pointer"
            >
        ...
        {/* Cap warning */}
        {isAtCap && (
          <div className="px-4 py-2 bg-[#FFF7E6] border-b-3 border-black">
            <p className="text-sm text-[#D46B08] font-medium">
            ...
            savedWords.map((word) => {
              ...
              return (
                <button
                  ...
                  className={`w-full rounded-xl border-3 border-black p-3 text-left transition-all duration-100 active:translate-y-[2px] active:shadow-[1px_1px_0_#000000] cursor-pointer ${
                    selected
                      ? "bg-[#E6F4FF] shadow-[3px_3px_0_#000000]"
                      : disabled
                        ? "bg-gray-100 opacity-50 cursor-not-allowed shadow-[3px_3px_0_#000000]"
                        : "bg-white shadow-[3px_3px_0_#000000] hover:bg-gray-50"
                  }`}
                >
                  <div className="flex items-center justify-between">
                    ...
                    {selected && (
                      <div className="ml-3 flex h-7 w-7 items-center justify-center rounded-full border-2 border-black bg-[#4096FF]">
                        <CheckOutlined
        ...
        <div className="border-t-3 border-black p-4">
          <button
            type="button"
            onClick={onClose}
            className="w-full rounded-xl border-3 border-black bg-[#4096FF] py-3 text-base font-bold text-white shadow-[4px_4px_0_#000000] transition-all duration-100 active:translate-y-[2px] active:shadow-[1px_1px_0_#000000] cursor-pointer"
          >
            {isThai
